...
import 'package:test_kita_jaga_kita/auth/forget_pass.dart';
import 'package:test_kita_jaga_kita/auth/register.dart';
import 'package:test_kita_jaga_kita/services/global_methods.dart';
      ...
      body: Stack(
        children: [
          CachedNetworkImage(
            ...
            fit: BoxFit.cover,
            alignment: FractionalOffset(_animation.value, 10),
          ),
          Container(
                ...
                child: ListView(
                  children: [
                    Padding(
                      ...
                      child: Image.asset("assets/launch_image.png",width: 225.6, height: 266.4,),
                    ),
                    Form(
                      key: _loginFormKey,
                      child: Column(
